...
const famousQuote = "Two things are infinite: the universe and human stupidity; and I'm not sure about the universe.";
...
const quoteMessage = `${authorName} once said, "${famousQuote}"`;
// Print the message
...
let names = ["Ali", "Mohsin", "Saad", "Saif"];
...
//QUESTION-12
// Define an array called 'names' to store names of a few friends
let names1 = ["Ali", "Mohsin", "Saad", "Saif"];
...
let favoriteTransports = ["Car", "Bike", "Bus", "Train"];
...
let guestList = ["Mubashir", "Zaid", "Mohsin"];
...
//QUESTION-15
// Define an array to store names of people you'd like to invite to dinner
let guestList1 = ["Mubashir", "Zaid", "Mohsin"];
// Print the initial invitation messages
for (let i = 0; i < guestList1.length; i++) {
    console.log(`Assalam u alaikum ${guestList1[i]}, you are cordially invited to dinner at my home.`);
}
...
let indexOfNotPresent = guestList1.indexOf(notPresent);
...
//QUESTION-16
// Define an array to store names of people you'd like to invite to dinner
let guestList2 = ["Mubashir", "Zaid", "Mohsin"];
// Print the initial invitation messages
for (let i = 0; i < guestList2.length; i++) {
    console.log(`Assalam u alaikum ${guestList2[i]}, you are cordially invited to dinner at my home.`);
}
// Define the guest who can't make it and the new guest
let notPresent1 = "Zaid"; // Removed the colon ":"
let newGuest1 = "Saif"; // Removed the colon ":"
// Print the name of the guest who can't make it
console.log(`Unfortunately, Mr. ${notPresent1} can't make it to tomorrow's dinner.`);
// Update the guest list by replacing the guest who can't make it
let indexOfNotPresent1 = guestList2.indexOf(notPresent1);
...
//QUESTION-17
let guestList3 = ["Mubashir", "Zaid", "Mohsin"];
// Print the initial invitation messages
...
//QUESTION-18
let placesToVisit = ["Tokyo", "London", "Berlin", "Dubai", "Sydney"];
...
let guestList4 = ["Asif", "Mohsin", "Saif", "Daniyal", "Ali"];
// Calculate the number of guests
let numberOfGuests = guestList4.length;
...
//QUESTION-24
let name_1 = "Aamir";
let name_2 = "Muhammad Aamir";
let name_3 = "Aamir Sheikh";
if (name_1 == name_3) {
...
let other_countries = ["Germany", "France", "Italy", "Spain"];
...
let alien_color1 = 'yellow'; // or 'red'
...
//QUESTION-26/b
// Version 2: Alien's color is not green
let alien_color3 = 'yellow'; // or 'red'
// Check if the alien's color is green
...
//QUESTIOON-28
let age = 25; // You can set this value to test different stages of life
if (age < 2) {
...
//QUESTIOON-29
let favorite_fruits = ['apple', 'banana', 'mango', 'grape', 'strawberry'];
// Check for 'apple'
...
//QUESTIOON-30
let usernames = ['Admin', 'Noman', 'Hamza', 'Arslan', 'Mahira', 'Aena'];
...
//QUESTIOON-31
let usernames1 = ['admin', 'Noman', 'Hamza', 'Arslan', 'Mahira', 'Aena'];
...
//QUESTIOON-32
let current_users = ["mahira", "Arslan", "Nabeel", "Ali", "Mohsin"];
let new_users = ["mahira", "aena", "John", "Hamza", "Abdullah"];
...
//QUESTION-34
let favourite_pizza = ["pepperoni", "chicken tikka", "fajita"];
...
const magicians = ["Rameez", "Atif", "Nabeel",];
...
const magicians2 = ["abbas", "jawwad", "faraz"];
...
const magicians3 = ["Nabeel", "Atif", "Rameez"];
const greatMagicians2 = make_great2([...magicians3]); // Create a copy using spread operator
...
const mycar = createCar("Lexus", "LX600", { color: "white", year: 2024 });
console.log(mycar);
export {};
